...
public class RStarMBRQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/rstar-mbr-query-random.log", status);
        }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexWithRStartreeMBR.printStatus();
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/rstar-mbr-query-gaussian.log", status);
        }
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/rstarmbr/rstarmbr-query.log")
                .build();

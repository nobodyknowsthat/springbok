...
public class RTreeMBRQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/rtree-mbr-query-random.log", status);
        }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexWithRtreeMBR.printStatus();
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/rtree-mbr-query-gaussian.log", status);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/rtreembr/rtreembr-query.log")
                .build();
        new Runner(opt).run();
    }

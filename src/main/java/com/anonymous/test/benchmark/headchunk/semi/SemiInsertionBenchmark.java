...
public class SemiInsertionBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/geohash-semi-insertion-random.log", status);
        }
    }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexWithGeoHashSemiSplit.printStatus() + ", listSize = " + listSize + "\n\n";
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/headchunk/status/geohash-semi-insertion-gaussian.log", status);
        }
    }

...
/**
 * @author anonymous
 * @create 2022-01-10 5:44 PM
 **/
public class StorageSpatioTemporalPortoBenchmark {
    ...
    public static class BenchmarkState {
        ...
        public void setup() {
            ...
            int s3TimePartition = 1000 * 60 * 60;
            int s3SpatialPartition= 16;
            ...
            int flushBlockNumThresholdForMem = 10000 * 100000;
...
//            }
        ...
        public void printStatus() {
            String statusFilename = "/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/storage/status/insertion-status.log";
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(StorageSpatioTemporalPortoBenchmark.class.getSimpleName())
                //.output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/storage/query-spatialtemporal.log")
                .build();

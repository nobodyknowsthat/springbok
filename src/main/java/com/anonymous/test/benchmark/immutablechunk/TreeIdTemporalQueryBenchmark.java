...
public class TreeIdTemporalQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-idtemporal-query.log", status);
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexTree.printStatus();
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-idtemporal-gaussian.log", status);
            System.out.println(status);
        }
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/tree-idtemporal-test.log")
                .build();

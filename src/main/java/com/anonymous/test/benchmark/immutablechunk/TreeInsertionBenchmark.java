...
public class TreeInsertionBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-insertion-random.log", status);
        }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexTree.printStatus();
            System.out.println(status);
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-insertion-gaussian.log", status);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/tree-insertion-test.log")
                .build();
        new Runner(opt).run();

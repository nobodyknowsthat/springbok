...
public class TreeSpatialTemporalQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-spatio-temporal-random.log", status);
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexTree.printStatus();
            System.out.println(status);
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/status/tree-spatio-temporal-gaussian.log", status);
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/trajectory-index/benchmark-log/immutablechunk/tree-spatio-temporal.log")
                .build();

...
import com.anonymous.test.compression.StringCompressor;
...
public class SimpleSpringbokServer {
    ...
    static void initEmptySeriesStore() {
        ...
        seriesStore = SeriesStoreCreator.createEmptySeriesStore(S3LayoutSchemaName.SPATIO_TEMPORAL_STR, "springbok-store-csv", false);
    ...
    public static void main(String[] arg) throws Exception {
        //System.setProperty("sun.net.httpserver.nodelay", "true"); for small query, uncomment this
    ...
    static class SpatialTemporalQueryHandler implements HttpHandler {
        ...
        public void handle(HttpExchange httpExchange) throws IOException {
            ...
            if (resultString.length() < compressionThreshold) {
                ...
                os.write(StringCompressor.snappyCompressString(resultString));
            }
            os.close();
